...
import com.interview.tui.githubapi.error.controller.GitServiceErrorController
...
import com.interview.tui.githubapi.service.dto.response.RepositoryDtoHelper
...
class GitRepositoryControllerTest {
    ...
    fun findGitReposForUser_usernameGiven_shouldReturnFluxResponse() {
        ...
        whenever(gitService.findRepositoriesForUser(username))
    ...
    class WebTestConfiguration(
        ...
        val gitServiceErrorController: GitServiceErrorController,
    ) {
        @Bean
        fun testClient(): WebTestClient {
            return WebTestClient.bindToController(gitRepositoryController)
                .controllerAdvice(gitServiceErrorController)
                .build()
        }
    }
}